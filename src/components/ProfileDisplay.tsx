      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
        ...
        <div className="container max-w-4xl mx-auto px-4 py-10 relative">
          ...
          <Button
            asChild
            variant="ghost"
            className="absolute top-12 left-4 md:top-12 md:left-6 z-10 hover:bg-purple-300 transition-colors"
          >
          ...
          {/* Profile Header */}
          <div
            className={`mb-8 rounded-xl overflow-hidden shadow-lg transition-all duration-500 transform ${isVisible(0) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
          >
          ...
          {/* Profile Completion */}
          <Card
            className={`mb-8 p-4 hover:shadow-lg transition-shadow duration-300 bg-white/90 backdrop-blur-md animate-fade-in ${isVisible(1) ? 'opacity-100' : 'opacity-0'
              }`}
          >
          ...
          <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="animate-fade-in">
            <TabsList className={`w-full mb-6 bg-white/50 backdrop-blur-sm ${isVisible(2) ? 'opacity-100' : 'opacity-0'
              }`}>
            ...
            <TabsContent value="overview">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                {/* Personal Info Card */}
                <Card
                  className={`p-6 hover:shadow-lg transition-shadow duration-300 bg-white/90 backdrop-blur-md ${isVisible(3) ? 'opacity-100 animate-slide-in-left' : 'opacity-0'
                    }`}
                >
                ...
                {/* Bio Card */}
                <Card
                  className={`p-6 hover:shadow-lg transition-shadow duration-300 bg-white/90 backdrop-blur-md ${isVisible(4) ? 'opacity-100 animate-slide-in-right' : 'opacity-0'
                    }`}
                >
                  <div className="flex items-start gap-4">
              ...
              {/* Career Goals */}
              <Card
                className={`p-6 mb-6 hover:shadow-lg transition-shadow duration-300 bg-white/90 backdrop-blur-md ${isVisible(5) ? 'opacity-100 animate-slide-in-left' : 'opacity-0'
                  }`}
              >
              ...
              {/* Interests Preview */}
              <Card
                className={`p-6 hover:shadow-lg transition-shadow duration-300 bg-white/90 backdrop-blur-md ${isVisible(6) ? 'opacity-100 animate-slide-in-right' : 'opacity-0'
                  }`}
              >
