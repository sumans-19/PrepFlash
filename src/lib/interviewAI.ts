...
class EventEmitter {
  ...
  // Continue with the InterviewAI class, now extending our custom EventEmitter
  class InterviewAI extends EventEmitter {
    ...
    private fillerWords: string[] = ['um', 'uh', 'like', 'you know', 'actually', 'basically', 'literally'];
      ...
      if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
        ...
        if (this.recognition) {
          ...
          this.recognition.onresult = (event: SpeechRecognitionEvent) => {
            ...
            // Detect hesitation if the user is responding and there's a pause
            if (this.userIsResponding && finalTranscript === '' && interimTranscript === '') {
